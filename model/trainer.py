...
print("R² Score (for reference):", r2_score(y_test, y_pred))

# Save the model and encoder
joblib.dump(model, "safety_level_model.pkl")
joblib.dump(label_encoder, "label_encoder.pkl")
print("\nModel and encoder saved as 'safety_level_model.pkl' and 'label_encoder.pkl'")
